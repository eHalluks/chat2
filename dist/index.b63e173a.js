...
myFunAddIdToBook = ()=>{
    bookLibrary.forEach((element, i)=>{
        element.uniCode = (0, _nanoid.nanoid)();
        element.id = i + 1;
...
addNewBook = (event)=>{
    ...
    addInputValue.forEach((element, i)=>{
        if (i === 3) {
            ...
            if ((0, _lodash.isNaN)(testNumber1) === true) {
                element.focus();
                element.select();
                return test = 1;
            }
            ...
            if ((0, _lodash.isNaN)(testNumber2)) {
                element.focus();
                element.select();
                return test = 2;
            }
    ...
    if (test === 1) return alert("Year must be a number");
    else if (test === 2) return alert("Price must be a number");
...
},{"nanoid":"2ifus","lodash":"hsVIl"}],"2ifus":[function(require,module,exports) {
...
},{}],"hsVIl":[function(require,module,exports) {
var global = arguments[3];
(function() {
...
},{}]},["juhEU","hKMZ0"], "hKMZ0", "parcelRequireef3d")
